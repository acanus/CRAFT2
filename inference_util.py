...
def getDetBoxes_core(text_map, link_map, text_threshold, link_threshold, low_text, s = True):
    # prepare data
    ...
    ret, link_score = cv2.threshold(text_map, link_threshold, 1, 0)
    # ret, text_score1 = cv2.threshold(text_map, low_text, 255, 0)
    # ret, link_score1 = cv2.threshold(text_map, link_threshold, 255, 0)
